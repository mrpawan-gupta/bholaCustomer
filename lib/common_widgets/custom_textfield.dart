// ignore_for_file: implementation_imports, lines_longer_than_80_chars, comment_references
      ...
      if (hasValidator) {
        if (hasConfirmation && widget.showConfirmation) {
          return OutlineInputBorder(
            borderSide:
                BorderSide(color: AppColors().appPrimaryColor, width: 1.25),
            borderRadius: BorderRadius.circular(widget.borderRadius),
          );
        } else if (hasError) {
          return OutlineInputBorder(
            borderSide: BorderSide(color: AppColors().appRedColor, width: 1.25),
            borderRadius: BorderRadius.circular(widget.borderRadius),
          );
        }
      }
      ...
      child: Column(
        ...
        children: <Widget>[
          if (widget.labelText != null &&
              widget.showLabelAboveTextField) ...<Widget>[
            Text(
              widget.labelText!,
              style: TextStyle(
