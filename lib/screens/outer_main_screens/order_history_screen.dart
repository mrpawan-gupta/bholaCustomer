...
class OrderHistoryScreen extends GetView<OrderHistoryController> {
            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              return LiquidPullToRefresh(
                ...
                onRefresh: () async {
                  ...
                  controller.pagingControllerCategoriesHistory.refresh();
  ...
  Widget chipSelectionServices() {
    return ValueListenableBuilder<PagingState<int, Bookings>>(
      valueListenable: controller.pagingControllerServicesHistory,
      builder: (
  ...
  Widget chipSelectionCategories() {
    return ValueListenableBuilder<PagingState<int, Bookings>>(
      valueListenable: controller.pagingControllerCategoriesHistory,
      builder: (
        BuildContext context,
        PagingState<int, Bookings> value,
        Widget? child,
  ...
  Widget cardWidgetServices() {
    return Padding(
      ...
      child: PagedListView<int, Bookings>(
        shrinkWrap: true,
        pagingController: controller.pagingControllerServicesHistory,
        physics: const ScrollPhysics(),
        padding: EdgeInsets.zero,
        ...
        builderDelegate: PagedChildBuilderDelegate<Bookings>(
          ...
          itemBuilder: (BuildContext context, Bookings item, int index) {
            final List<Bookings> itemList =
                controller.pagingControllerServicesHistory.itemList ??
                    <Bookings>[];
            final int length = itemList.length;
            final bool isLast = index == length - 1;
            return Padding(
  ...
  Widget cardWidgetCategories() {
    return Padding(
      ...
      child: PagedListView<int, Bookings>(
        shrinkWrap: true,
        pagingController: controller.pagingControllerCategoriesHistory,
        physics: const ScrollPhysics(),
        padding: EdgeInsets.zero,
        keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
        builderDelegate: PagedChildBuilderDelegate<Bookings>(
          ...
          itemBuilder: (BuildContext context, Bookings item, int index) {
            final List<Bookings> itemList =
                controller.pagingControllerCategoriesHistory.itemList ??
                    <Bookings>[];
            final int length = itemList.length;
            final bool isLast = index == length - 1;
            return Padding(
