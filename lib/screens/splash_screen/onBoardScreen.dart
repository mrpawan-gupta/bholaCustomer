          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    ...
                    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                      RoundedRectangleBorder(
                          ...
                          side: BorderSide(color: AppColors().appOrangeColor,)
                      ),
                    ),
                  ...
                  child: Text(
                      AppLanguageKeys().strCONTINUE.tr,
            ...
            Text.rich(
              ...
              TextSpan(
                children: <InlineSpan>[
                  TextSpan(text: AppLanguageKeys().strProceeding.tr,
                  ...
                  TextSpan(text: AppLanguageKeys().strAnd.tr, style: TextStyle(
                    color: AppColors().appWhiteColor,),),
                  TextSpan(
