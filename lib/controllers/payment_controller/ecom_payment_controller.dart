...
class EcomPaymentController extends GetxController {
  final RxString rxOrderId = "".obs;
  ...
  Future<(bool, String, String)> orderTransactionAPICall() async {
    final Completer<(bool, String, String)> completer =
        Completer<(bool, String, String)>();

    await AppAPIService().functionPost(
      types: Types.order,
      endPoint: "ordertransaction",
      body: <String, dynamic>{"order": rxOrderId.value},
  ...
  Future<bool> orderTransactionStatusAPICall() async {
