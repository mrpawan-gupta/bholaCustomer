...
class EnLanguage {
  ...
  Map<String, String> appEnINLanguage = <String, String>{
    ...
    AppLanguageKeys().strText1: "In addition to being a major source of starch and energy,"
    ...
    AppLanguageKeys().strText2: "In addition to being a major source of starch and energy, "
